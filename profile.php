...
left: 93px;
border-radius: 4px;
background-color: rgba(0red, 0, 0, 0.1);
...
if(isset($_POST['submit'])){
    ...
    $random_number = rand(1,100); //if a user changes profile image it will create a new number serial for it in case someone has the same name
...
<!------update profile image on profiel-->
...
<div class="col-sm-6">
    ...
    //this is when the code displays post on profile  
    ...
    <a href='functions/delete_post.php?post_id=$postid' style='float:right;'><button class='btn btn-danger'>Delete</button></a>
</div><br><br>
        ";
    }
