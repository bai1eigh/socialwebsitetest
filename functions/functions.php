...
//insert  poost information 
		...
		}else{ //uploading image into post
...
if(isset($_GET['post_id'])){
	...
	$post =  $_GET['post_id'];
	$get_user="select post_id from posts where post_id='$post'";
	...
	if($p_id != $post_id){
		...
		//where users can comment on others posts 
		...
		<textarea placeholder='write you comment here!'
