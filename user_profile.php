...
<body>
    <div class="row">
        <!---takes a user to another users profile-->
<?php
...
";
         ...
         ?>
<div class="col-sm-8">
    <center><h1><strong></strong>Their Posts</h1></center>
    <?php
         global $con;
         if(isset($_GET['u_id'])){
              $u_id = $_GET['u_id'];
        ...
        <div id='own_posts'>
            <div class='row'>
                <div class='col-sm-2'>
                    ...
                    <div class='col-sm-6'>
                    <h3><a style ='text-decoration:none;cursor: crosshair; color: #3897f0;'href = 'user_profile.php?u_id=$user_id'>$user_name</a></h3>
